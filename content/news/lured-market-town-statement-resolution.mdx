...
description: "The Town of Lake Lure's September 5 public statement on the Second Mountain lawsuit is heavy on narrative and light on the one document that actually decides what happens next. Resolution No. 26-08-28 — the Council's own conditional vote on the lease termination — and nearly three hours of logged closed-session meetings on this one case are both buried in the Town's own 98-page meeting packet, and neither makes it into the statement."
