...
<div className="not-prose my-6 rounded-xl border border-(--lake) bg-(--lake)/5 p-4 text-sm text-(--ink)/80">
  <strong className="text-(--forest)">Update, September 4:</strong> The hearing described as "canceled" below did, in fact, take place on September 3 after a court clerk reversed the cancellation hours before it. See <a href="/news/lured-market-magistrate-continuance" className="font-semibold text-(--lake) underline">our full report on what happened in that hearing, the continuance to September 15, and what it means going forward</a>.
</div>
