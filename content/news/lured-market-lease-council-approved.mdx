...
<div className="not-prose my-6 rounded-xl border border-(--lake) bg-(--lake)/5 p-4 text-sm text-(--ink)/80">
  <strong className="text-(--forest)">Update, August 25:</strong> Hundreds turned out Monday night after the mayor tried to keep this off the agenda. Read the follow-up: <a href="/news/lured-market-monday-hearing" className="font-semibold text-(--lake) underline">Cut Off, Then Cheered: Inside Monday's Packed Lake Lure Hearing →</a>
</div>
