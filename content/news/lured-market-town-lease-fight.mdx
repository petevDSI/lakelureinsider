...
<div className="not-prose my-6 rounded-xl border border-(--lake) bg-(--lake)/5 p-4 text-sm text-(--ink)/80">
  <strong className="text-(--forest)">Update, August 24:</strong> Lured Market released the lease, the termination notice, and Council meeting records this weekend. Read the follow-up: <a href="/news/lured-market-lease-council-approved" className="font-semibold text-(--lake) underline">The Lease the Council Actually Approved →</a>
</div>

<div className="not-prose my-6 rounded-xl border border-(--lake) bg-(--lake)/5 p-4 text-sm text-(--ink)/80">
  <strong className="text-(--forest)">Update, August 25:</strong> Court records show the Town filed to evict Lured Market at 3:27 p.m. Monday — hours before, not after, the packed public hearing where the mayor said the dispute was off the agenda. Read the latest: <a href="/news/lured-market-monday-hearing" className="font-semibold text-(--lake) underline">Filed at 3:27 P.M. — Before the Hearing, Not After →</a>
</div>
