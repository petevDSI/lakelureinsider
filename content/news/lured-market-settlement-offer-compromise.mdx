...
<div className="not-prose my-6 rounded-xl border border-(--lake) bg-(--lake)/5 p-4 text-sm text-(--ink)/80">
  <strong className="text-(--forest)">Correction and update, August 29:</strong> An earlier version of this piece stated the Town's settlement document was signed by both parties. It is not — the copy released Friday carries blank signature lines for Paul Brock and Town Manager Olivia Stewman, not actual signatures. We've corrected that below. Lured Market & Grill has also posted its own response, calling the offer "not... even a good faith proposal" but "an ultimatum" — see "Lured Market responds" below.
</div>
...
Correction: an earlier version of this piece stated the settlement document carried both parties' signatures. It doesn't. The copy released Friday has blank signature lines for Paul Brock and for Town Manager Olivia Stewman — spaces for signatures, not signatures. That makes this, formally, a proposed settlement the Town is asking Second Mountain to sign, not an agreement either side has actually entered into.
