...
<div className="not-prose my-6 rounded-xl border border-(--lake) bg-(--lake)/5 p-4 text-sm text-(--ink)/80">
  <strong className="text-(--forest)">Update, August 31:</strong> Today's deadline in the Town's offer has passed without an agreement. Lured Market has countered with a rent-adjustment proposal, Commissioner Jim Proctor has publicly called that unreasonable, and Second Mountain says a key 2023 Town document has gone missing from the Town's website. Full Monday update: <a href="/news/lured-market-monday-standoff" className="font-semibold text-(--lake) underline">Where things stand today →</a>
</div>
