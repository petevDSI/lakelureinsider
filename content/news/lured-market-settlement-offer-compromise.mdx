...
description: "Friday night at 7:55 p.m., the Town posted a settlement offer: Second Mountain drops its boathouse claim and pays full back rent by Monday, or nothing changes. Three years of the Town's own records show the boathouse was never an afterthought — and the 'solution' the Town is citing as agreement never mentioned rent at all."
...
**At 7:55 p.m. Friday, August 28, the Town of Lake Lure posted an "Updated Public Response Regarding Second Mountain, LLC" along with a short-form settlement agreement. The terms: Second Mountain permanently abandons any claim to the police boathouse at 2662 Memorial Highway, and pays the Town all past-due rent on its lease at 2654 Memorial Highway — $3,218.00 — by Monday, August 31. In exchange, the existing lease continues, at the existing rent, with nothing adjusted for the amenity Second Mountain is giving up. The document carries two signatures: Paul Brock for Second Mountain, and Town Manager Olivia Stewman for the Town. There's no Council resolution attached, and no record of an open-session vote on it.**
...
## Whose signature is this, and has the Council voted on it?

The settlement document is signed by Paul Brock and by Town Manager Olivia Stewman. It is not signed by, or attached to, a Council resolution, and nothing in the Friday statement says the Council voted on these terms in open session before they went out. That's the same open question this outlet has been asking since before this offer existed: as we reported in <a href="/news/lured-market-reconvened-meeting-notice-law" className="font-semibold text-(--lake) underline">The Meeting No One Saw End</a>, North Carolina law is clear that a binding decision on this lease — accepting a settlement, reinstating the lease, dropping the eviction — has to happen in open session, in public, by a Council vote. A "tentative consensus" reached behind closed doors, or a document a Town Manager signs, doesn't satisfy that requirement on its own. If the Council voted on these specific terms in open session at some point we haven't seen reported, we'd like to know when and where. If it hasn't, this settlement offer sits in the same unresolved place as the termination decision that started this dispute: a significant step, taken by staff, without a disclosed public vote behind it.
